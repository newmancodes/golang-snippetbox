...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// characters long. If it fails either of these checks, add a message to the
	...
	// Check the expres value matches one of our permitted values (1, 7, or
	// 365).
	if form.Expires != 1 && form.Expires != 7 && form.Expires != 365 {
		form.FieldErrors["expires"] = "This field must equal 1, 7, or 365"
	}

	// If there are any validation errors, then the create.tpml template,
